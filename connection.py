...
def send_to_event_hub(ride_data=None, batch_size=1):
    ...
    try:
        ...
        ride_json = json.dumps(ride_data)  # ride_data passed as paramter above
...
if __name__ == "__main__":
    ...
    print("=" * 80)
    ride = generate_uber_ride_confirmation() # get data
    print(json.dumps(ride, indent=2))  #print for reference

    
    print("\n" + "=" * 80)
    print("SENDING SINGLE RIDE TO EVENT HUB")
    result = send_to_event_hub(ride) #sending data
